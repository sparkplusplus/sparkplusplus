...
The docs site lives under `website/`.
...
- Sonatype publish on tag push

Contributors changing workflows should keep Java/Maven concerns separate from docs/Node concerns unless coupling is necessary.
